...
CKPT_PATH = "lightning_logs/version_48/best_checkpoint.ckpt"
...
dataset =get_dw_dataset.get_dw_dataset(Path('./bin/synthetic_datasets1/test/data.json'),freq='H',prediction_length=100) 
...
plt.title("Guided Diffusion Forecast (position) — Multiple Trajectories")
plt.xlabel("Time")
plt.ylabel("Value")
plt.legend()
#plt.ylim(-200, 250)
